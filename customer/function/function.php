  ...
  $row_c = mysqli_fetch_array($run_c);
      $customer_id = $row_c['customer_id'];
                  ...
                  if($count_orders>0)
                  {
                    ...
                    <h3>please see your order details by clicking this <a href='my_account.php?view_order' style='color:green;''>
                    LINK </a><br><br>Or you can Scan Following QR code for Payment <a href='pay_offline'</a>
                    </h3>
                    </div>
                    ";
                  }
...
{  
                        ...
                        while( $row_category = mysqli_fetch_array($run_category))
                        {
                        	...
                        	$cat_id=$row_category['cat_id'];
                             echo"
                                    <li ><a href='shopping.php?cat_id=$cat_id' style='font-size:20px;'>$cat_title</li>";
                        }
}
